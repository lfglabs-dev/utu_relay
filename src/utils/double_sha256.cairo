// from:
// https://github.com/keep-starknet-strange/raito/blob/1d2a115d872ea3b6e68eab345b4dde4d50f20d1a/packages/utils/src/hash.cairo
// this version is modified to use the sha256 built in Starknet
